...
export default class TravelNoteEdit extends React.Component {
    state = {
        avatarSource: [[], [], [], [], [], [], [], [], [], []], //图片
        imgSource: [[], [], [], [], [], [], [], [], [], []],
        text: '',
    ...
    render() {
        ...
        for (var i = 0; i < this.state.number; i++) {
            if(i === this.state.number - 1){
                if (chooseTemplate[i] === 1) {
                    arr.push(
                        <View key={i} style={{ flex: 1, height: 230, marginBottom: 50 }}>
                ...
                if (chooseTemplate[i] === 2) {
                    arr.push(
                        <View key={i} style={{ flex: 1, height: 390, marginBottom: 50 }}>
                ...
                if (chooseTemplate[i] === 3) {
                    arr.push(
                        <View key={i} style={{ flex: 1, height: 430, marginBottom: 50 }}>
            ...
            <View>
                ...
                {this.state.isEdit ?
                    ...
                    <ActionButton buttonColor="rgba(231,76,60,1)" buttonColor='#9b59b6' offsetX={20} offsetY={100} onPress={() => this.props.navigation.navigate('TravelNoteEdit')}>
                        ...
                        <ActionButton.Item buttonColor='#3498db' title="添加" onPress={() => {
                            this.setState({
                                slideAnimationDialog: true
                            })
                        }}>
                        ...
                        <ActionButton.Item buttonColor='#1abc9c' title="保存" onPress={() => this.saveNotes()}>
